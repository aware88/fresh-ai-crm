...
echo -e "${BLUE}=== Metakocka Integration Test Suite ===${NC}\n"
...
# Run all tests
run_test "Contact Sync Test" "run-contact-sync-test.sh" "contact-sync-test.env.sample"
run_test "Product Sync Test" "run-product-sync-test.sh" "product-sync-test.env.sample"
...
run_test "Email Integration Test" "run-metakocka-email-test.sh" "metakocka-email-test.env.sample"
