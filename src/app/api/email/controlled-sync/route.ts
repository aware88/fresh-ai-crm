...
/**
 * CONTROLLED EMAIL SYNC
 * 
 * Syncs specific number of received and sent emails with precise control
 * Designed for testing and controlled production sync
 */
export async function POST(request: NextRequest) {
  try {
    ...
    console.log(`🎯 CONTROLLED SYNC: ${receivedCount} received + ${sentCount} sent emails (test=${testMode})`);
    ...
    console.log(`📧 Starting controlled sync for ${account.email}...`);
    ...
    try {
      ...
      console.log(`✅ Controlled sync complete: ${totalSaved} emails saved`);
