                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <CardDescription className="text-blue-100">
                      View, add, edit, and manage your suppliers
                    </CardDescription>
                  </div>
                </div>
                <Button 
                  ...
                  onClick={() => {
                    // This will be handled by the SupplierList component
                    const addButton = document.querySelector('[data-add-supplier]') as HTMLButtonElement;
