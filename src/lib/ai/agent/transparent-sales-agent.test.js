...
const { TransparentSalesAgent } = require('./transparent-sales-agent');
const { TransparencyService } = require('../transparency/transparency-service');
const { v4: uuidv4 } = require('uuid');
const config = require('../transparency/test.config.cjs');
...
describe('TransparentSalesAgent', () => {
  ...
  beforeEach(() => {
    ...
    TransparencyService.mockImplementation(() => ({
  ...
  describe('getRelevantMemories', () => {
    it('should return relevant memories for a contact', async () => {
      ...
      const memories = await transparentAgent['getRelevantMemories'](mockContactId, 'Hello');
  ...
  describe('makeDecision', () => {
    it('should return a decision with approach and alternatives', async () => {
      ...
      const decision = await transparentAgent['makeDecision'](message, memories);
